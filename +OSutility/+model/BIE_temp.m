classdef BIE_temp < handle
    ...
    properties
        ...
        splice_from_i = []; % location of specified nodes
        pin_dof = 5;        % unconstrained degree of freedom
    ...
    methods
        ...
        function obj = BIE_temp(db, sec, sec_n, geom_transf, geom_transf_rig, node_i, node_j, varargin)
