classdef cyclic1 < OpenSees
    ...
    methods
        ...
        function obj = cyclic1(ctrlNode,ctrldof,targetDisp,targetIncr,tol,maxIter)
...
%             end
            ...
            obj.cmdLine = [obj.cmdLine '\n' ...
                           ...
                           '\t\t\t\t'           'incr counter;\n'...
                           '\t\t\t\t'           'if {$counter > 4} {\n' ...
                           '\t\t\t\t\t'             'set tempTol [expr $tempTol*10];\n' ...
                           '\t\t\t\t\t'             'test NormDispIncr $tempTol $maxIter;\n'...
                           '\t\t\t\t\t'             'set counter 0;\n' ...
                           '\t\t\t\t'           '};\n'...
