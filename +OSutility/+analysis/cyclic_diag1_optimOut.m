classdef cyclic_diag1_optimOut < OpenSees
    ...
    methods
        ...
        function obj = cyclic_diag1_optimOut(ctrlNodeAnalysis, ctrldofAnalysis, ctrlNode,ctrldof,targetDisp,targetIncr,tol,maxIter)
            ...
            obj.cmdLine = [obj.cmdLine '\n' ...
                           ...
                           'set optimOut "./out/optim_force.out";\n' ...
                           'set optimFID [open $optimOut "w"];\n' ...
