classdef input_accelerogram_damping_period_drift < OpenSees
    ...
    methods
        ...
        function obj = input_accelerogram_damping_period_drift(gm, g, dof, dt, min_dt, free_time, tol, max_iter, zeta, mode_i, mode_j, node_damp, ele_damp, out_folder, ele_brace)
            ...
            obj.cmdLine = [obj.cmdLine '\n' ...
                           ...
                           '\t\t\t\t'           'if {$ok != 0 && $dt_temp < [expr $min_dt*1000.0]} {\n' ...
                           '\t\t\t\t\t'             'puts "\t\t> trying NewtonLineSearch (RegulaFalsi)";\n' ...
                           '\t\t\t\t\t'             'test EnergyIncr [expr $conv_tol*10.0] $max_iter;\n' ...
...
%                            '\t\t\t\t\t'             'algorithm KyrlovNewton -maxDim 6;\n' ...
