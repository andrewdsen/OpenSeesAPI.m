...
classdef Steel02 < OpenSees.model.uniaxialMaterial
    ...
    methods
        ...
        function obj = Steel02(tag,Fy,E0,b,R0,CR1,CR2,a1,a2,a3,a4,sigInit)
            ...
            % command line open
            obj.cmdLine = ['uniaxialMaterial Steel02 ' ...
                           num2str(obj.tag) ' ' ...
        ...
        function rewrite(obj)
            ...
            if ~isempty(obj.a1) && ~isempty(obj.a2) && ~isempty(obj.a3) && ~isempty(obj.a4) && ~isempty(obj.sigInit)
