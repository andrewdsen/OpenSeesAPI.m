classdef Bilin < OpenSees
    ...
    properties
        ...
        % optional
        nFactor = [];       % elastic stiffness amplification factor, mainly for use with concentrated plastic hinge elements
        
    end
    
    methods
        
        function obj = Bilin(tag,K0,as_Plus,as_Neg,...
                My_Plus,My_Neg,...
            ...
            if nargin >= 24
                ...
                % command line open
                obj.cmdLine = ['uniaxialMaterial Bilin ' num2str(obj.tag) ' '...
            ...
            if nargin == 25
                ...
                obj.cmdLine = [obj.cmdLine ' ' ...
                               num2str(obj.nFactor,obj.format)];
